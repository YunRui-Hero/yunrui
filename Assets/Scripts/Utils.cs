...
public class Utils
{
    ...
    {
        // 2D physics offer Collider2D.Distance(Collider2D)
        // which works for far-apart and overlapping!
        ColliderDistance2D distance2D = a.Distance(b);
        return distance2D.isOverlapped ? 0 : distance2D.distance;
    }
